#ifndef LORA_H
#define LORA_H
#define  MD_LORA_AUX_PIN          P13.7
#define  MD_LORA_EN_PIN           P4.5
#define  MD_LORA_EN_PIN_RESET     P4.5=0
#define  MD_LORA_EN_PIN_SET       P4.5=1
#define  MD_LORA_SET_PIN_RESET    P4.4=0
#define  MD_LORA_SET_PIN_SET      P4.4=1
